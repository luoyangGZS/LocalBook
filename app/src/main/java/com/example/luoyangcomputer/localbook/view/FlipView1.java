 ...
 * on 2018/10/29 1:04
 */
public class FlipView1 extends View {
    ...
    private class SlideHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            // 重绘视图
            FlipView1.this.invalidate();
            // 循环调用滑动计算
            FlipView1.this.slide();
        }
    ...
    public FlipView1(Context context) {
        this(context, null);
    }

    public FlipView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
