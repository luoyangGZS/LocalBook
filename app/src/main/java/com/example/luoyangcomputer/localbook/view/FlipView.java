package com.example.luoyangcomputer.localbook.view;
...
import com.example.luoyangcomputer.localbook.animation.AnimationProvider;
import com.example.luoyangcomputer.localbook.animation.CoverAnimation;
import com.example.luoyangcomputer.localbook.animation.NoneAnimation;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isPrePageOver) {
            ...
            if (mFlipStyle == FlipStyle.STYLE_COVER)
                flipCover(canvas);
//            mAnimationProvider = new CoverAnimation(mBitmapList.get(mPrePage),mBitmapList.get(mNextPage),mScreenWidth,mScreenHeight);
//            mAnimationProvider.drawMove(canvas);

            //无效果翻页
            if (mFlipStyle == FlipStyle.STYLE_NO_EFFECT)
               flipNoEffect(canvas);
//                mAnimationProvider = new NoneAnimation(mBitmapList.get(mPrePage),mBitmapList.get(mNextPage),mScreenWidth,mScreenHeight);
//             mAnimationProvider.drawMove(canvas);
